...
We demonstrate this method by instruction-finetuning LLaMA 7B on the [extes](https://github.com/tatsu-lab/stanford_extes) dataset on a **single RTX 3090 (24GB) GPU**.
