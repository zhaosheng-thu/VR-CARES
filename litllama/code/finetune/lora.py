"""
Instruction-tuning with LoRA on the extes dataset.
...
from scripts.prepare_extes import generate_prompt

INPUT_FILE_DIR = "data/any"
DEVICE = 'cuda'
...
weight_decay = 0.0
max_seq_length = 2048  # see scripts/prepare_extes.py and prepare_any_text.py
lora_r = 8
lora_alpha = 16
lora_dropout = 0.05
warmup_iters = 100
wandb.init(project="Llama-Lora-ES", name="llama2-7b")


def main(
    data_dir: str = INPUT_FILE_DIR, 
    pretrained_path: str = "checkpoints/lit-llama/7B/lit-llama.pth",
    tokenizer_path: str = "checkpoints/lit-llama/tokenizer.model",
    out_dir: str = "out/lora/esconv",
):

    fabric = L.Fabric(accelerator=DEVICE, devices=1, precision="bf16-true")
    fabric.launch()
    ...
    config.block_size = max_seq_length ### why?
...
def get_batch(fabric: L.Fabric, data: list):
    ...
    # print("test-data", data[0:20])
    # test for the format and content of data
