"""
Instruction-tuning with LLaMA-Adapter v2 on the extes dataset following the paper
...
weight_decay = 0.02
max_seq_length = 256  # see scripts/prepare_extes.py
...
def main(
    data_dir: str = "data/extes", 
    pretrained_path: str = "checkpoints/lit-llama/7B/lit-llama.pth",
    out_dir: str = "out/adapter_v2/extes",
):
